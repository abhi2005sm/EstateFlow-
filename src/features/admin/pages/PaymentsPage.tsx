  ...
  return (
    <div className="min-h-screen bg-[#F5F3F0] dark:bg-[#09090b] relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          <div>
            <h1 className="text-xl font-black text-[#121110] dark:text-white tracking-tight">Payment Management</h1>
            <p className="text-[10px] font-black text-[#61605D] dark:text-gray-400/60 uppercase tracking-[0.25em]">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="relative p-3 bg-white/70 dark:bg-[#18181b]/70 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-2xl shadow-sm hover:bg-white dark:bg-[#18181b] transition-all active:scale-95">
            ...
            <div className="flex items-center space-x-3 bg-white/70 dark:bg-[#18181b]/70 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-2xl px-4 py-2 shadow-sm cursor-pointer hover:bg-white dark:bg-[#18181b] transition-all active:scale-95">
              ...
              <div>
                <p className="text-xs font-black text-[#121110] dark:text-white">Admin Owner</p>
              </div>
            </div>
          </div>
        </motion.header>
        ...
        <main className="max-w-[1600px] mx-auto px-10 py-10">
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-3xl font-black text-[#121110] dark:text-white tracking-tight">Payments Overview</h2>
                <p className="text-[#61605D] dark:text-gray-400 font-semibold text-sm mt-1">Review, approve, and track all tenant payments.</p>
              </div>
