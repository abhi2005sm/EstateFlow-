...
export default function RevenueOverview({ delay = 0 }) {
  return (
    <motion.div
      ...
      className="bg-white/70 backdrop-blur-3xl rounded-[3rem] border border-white/30 shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-10 relative overflow-hidden h-full flex flex-col justify-between"
    >
      <div className="flex justify-between items-start relative z-10">
        <div className="space-y-1">
          <div className="flex items-center space-x-3">
            <h3 className="text-2xl font-black tracking-tight text-[#121110]">Market Revenue Overview</h3>
          ...
          <div className="flex items-center space-x-4 mt-8">
            <span className="text-5xl font-black tracking-tighter text-[#121110]">$5,120.00</span>
            <span className="bg-[#E6FFFA] text-[#047857] px-3 py-1.5 rounded-xl text-xs font-black">+20</span>
          </div>
        </div>
        <div className="flex flex-col items-end">
          <div className="flex items-center text-rp-success font-black text-2xl tracking-tighter">
      ...
      <div className="mt-14 space-y-6">
        ...
        <div className="flex items-center space-x-10">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xs font-black text-[#121110] uppercase tracking-widest opacity-80">Occupied Units - 83%</span>
          </div>
          <div className="flex items-center space-x-3">
