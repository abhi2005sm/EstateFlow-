            ...
            <div className="p-8 overflow-y-auto h-full">
              ...
              {activeTab === "Overview" && (
                <div>
                  ...
                  <div className="border border-gray-100 rounded-2xl p-5 flex items-start space-x-4">
                  ...
                  <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-4 mt-8">
                    Portfolio Summary
                  </h3>
