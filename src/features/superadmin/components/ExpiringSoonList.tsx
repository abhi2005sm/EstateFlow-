  ...
  return (
    <div className="space-y-4">
      {expiringSoonList.map((user) => (
        <div key={user.id} className="flex items-center justify-between p-3 hover:bg-gray-50 dark:bg-[#27272a] rounded-2xl transition-all border border-gray-50 hover:border-gray-100 dark:border-gray-800 group">
